/// Copy-paste of https://github.com/PFCal-dev/cmssw/blob/CMSSW_6_2_X_SLHC/GeometryReaders/XMLIdealGeometryESSource/interface/GeometryConfiguration.h 


#ifndef GeometryConfigurationHack_H
#define GeometryConfigurationHack_H
 ...
 **/
class GeometryConfigurationHack: public DDLDocumentProvider {

 public:
  GeometryConfigurationHack( const edm::ParameterSet & p );

  virtual ~GeometryConfigurationHack();
